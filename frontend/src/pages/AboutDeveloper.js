        ...
        <ParallaxSection offset={30}>
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl md:text-2xl text-white/60 mb-3 sm:mb-4 max-w-4xl mx-auto px-2"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg text-white/50 mb-8 sm:mb-12 max-w-3xl mx-auto px-2 leading-relaxed"
            >
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-center mb-6 sm:mb-8">
            <motion.div
              className="flex items-center justify-around bg-primary/30 rounded-xl sm:rounded-2xl p-1 sm:p-2 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-primary/100 w-full max-w-md sm:max-w-none overflow-x-auto"
              layout
            >
              {tabs.map((tab) => (
                <motion.button
                  ...
                  className={`flex items-center justify-center sm:justify-start gap-1 sm:gap-2 px-3 py-2 sm:px-6 sm:py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 whitespace-nowrap flex-1 sm:flex-none text-sm sm:text-base ${activeTab === tab.id
                      ? "bg-gradient-to-r from-primary/70 to-primary/100 text-white shadow-[0_4px_30px_rgba(0,0,0,0.5)]"
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-white/60 max-w-4xl mx-auto leading-relaxed px-2">
            ...
            >
              {aboutData.aboutProject.features.map((feature, index) => (
                <motion.div
                  ...
                  whileHover="hover"
                  className="bg-white/5 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-white/10 group cursor-pointer"
                >
                  <motion.div
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3 group-hover:text-blue-600 transition-colors">
                    {feature.title}
                  </h3>
            ...
            <motion.div variants={itemVariants} className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                {aboutData.aboutProject.technologies.map((tech, index) => (
                  <motion.div
                    key={index}
                    className="flex items-center gap-2 sm:gap-3 bg-white/5 px-4 py-3 sm:px-6 sm:py-4 rounded-xl sm:rounded-2xl shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-white/10"
                    whileHover={{ scale: 1.05, y: -5 }}
                    whileTap={{ scale: 0.95 }}
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 mb-12 sm:mb-16">
              ...
              >
                <div className="bg-white/5 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-white/10">
            ...
            <motion.div
              variants={itemVariants}
              className="bg-white/5 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-white/10"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {aboutData.aboutInstitution.achievements.map(
                  (achievement, index) => (
                    <motion.div
                      key={index}
                      className="flex items-center gap-3 p-3 sm:p-4 bg-gradient-to-r from-white/5 to-white/10 rounded-lg sm:rounded-xl"
            ...
            >
              {aboutData.aboutDevelopers.team.map((member, index) => (
                <motion.div
                  ...
                  whileHover="hover"
                  className="bg-white/5 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border border-white/10 text-center group relative overflow-hidden"
                  style={{ perspective: "1000px" }}
                >
                  {/* Background animation elements */}
                  <motion.div
                    className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(147,51,234,0.1),transparent_50%)] opacity-0"
                  ...
                  <motion.h3
                    className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2 group-hover:text-blue-600 transition-colors"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <motion.p
                    className="text-white/60 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <motion.blockquote
                    className="text-white/50 italic border-l-4 border-blue-500 pl-3 sm:pl-4 text-sm sm:text-base"
                    initial={{ opacity: 0, x: -20 }}
                    animate={{ opacity: 1, x: 0 }}
              ...
              <div className="space-y-4 sm:space-y-6">
                {aboutData.aboutDevelopers.developmentProcess.map(
                  (phase, index) => (
                    <motion.div
                      key={index}
                      className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 p-4 sm:p-6 bg-gradient-to-r from-white/5 to-white/10 rounded-lg sm:rounded-xl"
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white/60 max-w-3xl mx-auto px-2">
          ...
          >
            {aboutData.testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <blockquote className="text-white/60 leading-relaxed italic text-sm sm:text-base">
                  "{testimonial.message}"
                </blockquote>
              </motion.div>
            ))}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <motion.div
              ...
              className="mb-6 sm:mb-8"
            >
              <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-white/5 bg-opacity-20 rounded-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              ...
              >
                ...
                <span className="text-sm sm:text-base">KV Bhopal, MP</span>
              </motion.div>
            </div>

            <motion.button
              className="bg-white/5 text-blue-600 px-6 py-3 sm:px-8 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg shadow-[0_4px_30px_rgba(0,0,0,0.5)] hover:shadow-xl transition-all duration-300"
