...
exports.approveRegistration = async (req, res) => {
    try {
        ...
        try {
            await sendEmail({
                email: user.email,
                subject: `${user.fullName}, Welcome Home! Your KV Bhopal Alumni Connect Account is Now Active 🎉`,
                message: `
    <div style="font-family:Segoe UI, Roboto, sans-serif; max-width:600px; margin:auto; padding:20px; border-radius:8px; background:#f9f9f9; color:#333;">
      ...
      <p style="font-size:16px;">🎉 <strong>It's official</strong>, your KV Bhopal Alumni Connect account has been <span style="color:green;"><strong>approved!</strong></span></p>
